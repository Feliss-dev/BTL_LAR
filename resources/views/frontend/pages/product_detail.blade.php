									...
									<div class="col-lg-6 col-12">
										<div class="product-des">
											...
											<div class="product-buy">
												...
												<p class="cat">Category :<a href="{{route('products', [ 'categories' => $product_detail->cat_info['slug'] ])}}">{{$product_detail->cat_info['title']}}</a></p>
                                                    @if($product_detail->sub_cat_info)
                                                        <p class="cat mt-1">Sub Category :<a href="{{route('products', [ 'categories' => implode(',', [ $product_detail->cat_info['slug'], $product_detail->sub_cat_info['slug'] ]) ])}}">{{$product_detail->sub_cat_info['title']}}</a></p>
                                                    @endif
