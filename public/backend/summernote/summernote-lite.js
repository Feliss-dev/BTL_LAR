        ...
        /******/ {
            ...
            /***/ 1: /***/ function(
                ...
                class Renderer {
                    ...
                    render($parent) {
                        const $node = jquery__WEBPACK_IMPORTED_MODULE_0___default()(
                            this.markup
                        );
            ...
            /***/ 3: /***/ function(
                ...
                function rect2bnd(rect) {
                    const $document = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                        document
                    );
                    return {
                ...
                function wrap(node, wrapperName) {
                    ...
                    const wrapper = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                        "<" + wrapperName + ">"
                    )[0];
                ...
                function posFromPlaceholder(placeholder) {
                    const $placeholder = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                        placeholder
                    );
                ...
                class Context_Context {
                    ...
                    _initialize() {
                        ...
                        const buttons = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.extend(
                            {},
                        ...
                        const modules = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.extend(
                            {},
                    ...
                    createInvokeHandler(namespace, value) {
                        return event => {
                            ...
                            const $target = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                                event.target
                            );
                            this.invoke(
                                namespace,
                ...
                external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.fn.extend(
                    {
                         ...
                         */
                        summernote: function() {
                            const type = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.type(
                                lists.head(arguments)
                            );
                            const isExternalAPICalled = type === "string";
                            const hasInitOptions = type === "object";
                            const options = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.extend(
                                {},
                                external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default
                            ...
                            options.tooltip =
                                options.tooltip === "auto"
                                    ...
                                    : options.tooltip;
                            this.each((idx, note) => {
                                const $note = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                                    note
                                );
                ...
                function pointToTextRange(point) {
                    const textRangeInfo = function(container, offset) {
                        ...
                        if (dom.isText(container)) {
                            ...
                            const prevContainer = lists.last(prevTextNodes)
                                .previousSibling;
                ...
                class range_WrappedRange {
                    ...
                    scrollIntoView(container) {
                        const height = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                            container
                        ).height();
                    ...
                    pasteHTML(markup) {
                        ...
                        const contentsContainer = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                            "<div></div>"
                        ).html(markup)[0];
                    ...
                    getWordRange(findAfter) {
                        ...
                        if (findAfter) {
                            endPoint = dom.nextPointUntil(endPoint, function(
                                point
                            ) {
                                return !dom.isCharPoint(point);
                            });
                ...
                function createImage(url) {
                    return external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a
                        .Deferred(deferred => {
                            const $img = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                                "<img>"
                            );
                            $img.one("load", () => {
                                $img.off("error abort");
                ...
                class Style_Style {
                    ...
                    fromNode($node) {
                        ...
                        styleInfo["font-size-unit"] = fontSize.match(
                            /[a-z%]+$/
                        );
                        return styleInfo;
                    }
                    ...
                    current(rng) {
                        const $cont = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                        ...
                        external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.each(
                            ...
                            (idx, paras) => {
                                ...
                                if (headList.parentNode.nodeName === "LI") {
                                    paras.map(para => {
                                        const newList = this.findNextSiblings(
                                            para
                                        );
                        ...
                        while (canContinue) {
                            ...
                            switch (action) {
                                case TableResultAction.requestAction.Add:
                                    resultAction = getAddResultActionToCell(
                                        cell
                                    );
                                    break;

                                case TableResultAction.requestAction.Delete:
                                    resultAction = getDeleteResultActionToCell(
                                        cell
                                    );
                                    break;
                            }
                ...
                class Table_Table {
                    ...
                    addRow(rng, position) {
                        ...
                        const currentTr = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                            cell
                        ).closest("tr");
                        const trAttributes = this.recoverAttributes(currentTr);
                        const html = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                            "<tr" + trAttributes + "></tr>"
                        );
                            ...
                            switch (currentCell.action) {
                                ...
                                case TableResultAction.resultAction
                                    ...
                                    if (position === "top") {
                                        ...
                                        if (isTopFromRowSpan) {
                                            const newTd = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                                                "<div></div>"
                                            )
                                                .append(
                                                    external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                    ...
                    addCol(rng, position) {
                        ...
                        const row = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                            cell
                        ).closest("tr");
                        const rowsGroup = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                            row
                        ).siblings();
                        rowsGroup.push(row);
                        const vTable = new TableResultAction(
                    ...
                    createTable(colCount, rowCount, options) {
                        ...
                        trHTML = trs.join("");
                        const $table = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                            "<table>" + trHTML + "</table>"
                        );
                ...
                class Editor_Editor {
                    constructor(context) {
                        ...
                        this.pasteHTML = this.wrapCommand(markup => {
                            ...
                            const contents = this.getLastRange().pasteHTML(
                                markup
                            );
                            this.setLastRange(
                                core_range
                        ...
                        this.formatBlock = this.wrapCommand(
                            (tagName, $target) => {
                                const onApplyCustomStyle = this.options
                                    .callbacks.onApplyCustomStyle;
                        ...
                        this.removeMedia = this.wrapCommand(() => {
                            let $target = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                                this.restoreTarget()
                            ).parent();
                    ...
                    setLastRange(rng) {
                        if (rng) {
                            ...
                            if (
                                ...
                                this.lastRange = core_range.createFromBodyElement(
                                    this.editable
                                );
                            }
                        }
                        ...
                        if ($target && $target.length) {
                            ...
                            if ($target && $target.length) {
                                ...
                                if (className) {
                                    ...
                                    const $parent = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                    ...
                    getLinkInfo() {
                        ...
                        const $anchor = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                ...
                class Handle_Handle {
                    ...
                    update(target, event) {
                        ...
                        if (isImage) {
                            const $image = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                                target
                            );
                    ...
                    replace() {
                        ...
                        if (match && (match[1] || match[2])) {
                            ...
                            const urlText = keyword
                                ...
                                .split("/")[0];
                            const node = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                                "<a />"
                            )
                                .html(urlText)
                                .attr("href", link)[0];
                ...
                class Buttons_Buttons {
                            ...
                            .buttonGroup({
                                ...
                                children: [
                                    this.button({
                                        ...
                                        tooltip: tooltip,
                                        click: e => {
                                            const $button = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                                                e.currentTarget
                                            );
                                    ...
                                    this.ui.dropdown({
                                        ...
                                        callback: $dropdown => {
                                            $dropdown
                                                .find(".note-holder")
                                                .each((idx, item) => {
                                                    const $holder = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                                                        item
                                                    );
                                                    $holder.append(
                                                        this.ui
                                        ...
                                        click: event => {
                                            ...
                                            const eventName = $button.data(
                                                "event"
                                            );
                                            let value = $button.attr(
                                                "data-value"
                                            );
                                            ...
                                            if (eventName === "openPalette") {
                                                ...
                                                const $palette = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                                                    $parent
                                                        .find(
                                                            "#" +
                                                                $picker.data(
                            ...
                            return this.ui
                                .buttonGroup([
                                    ...
                                    this.ui.dropdownCheck({
                                        ...
                                        checkClassName: this.options.icons
                                            .menuCheck,
                    ...
                    updateCurrentStyle($container) {
                        ...
                        if (styleInfo["font-family"]) {
                            ...
                            $cont
                                ...
                                .each((idx, item) => {
                                    const $item = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                                        item
                    ...
                    tableMoveHandler(event) {
                        const PX_PER_EM = 18;
                        const $picker = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                        ...
                        if (event.offsetX === undefined) {
                            const posCatcher = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                                event.target
                            ).offset();
                            posOffset = {
                ...
                class LinkDialog_LinkDialog {
                    ...
                    showLinkDialog(linkInfo) {
                        return external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a
                            .Deferred(deferred => {
                                const $linkText = this.$dialog.find(
                                    ".note-link-text"
                                );
                                const $linkUrl = this.$dialog.find(
                                    ".note-link-url"
                                );
                                const $linkBtn = this.$dialog.find(
                                    ".note-link-btn"
                                );
                                ...
                                this.ui.onDialogShown(this.$dialog, () => {
                                    ...
                                    $linkBtn.one("click", event => {
                                        ...
                                        deferred.resolve({
                                            ...
                                            url: $linkUrl.val(),
                                            text: $linkText.val(),
                                            isNewWindow: $openInNewWindow.is(
                                                ":checked"
                                            ),
                                            checkProtocol: $useProtocol.is(
                                                ":checked"
                                            )
                                        });
                                        this.ui.hideDialog(this.$dialog);
                    ...
                    show() {
                        const linkInfo = this.context.invoke(
                            "editor.getLinkInfo"
                        );
                ...
                class LinkPopover_LinkPopover {
                    ...
                    update() {
                        ...
                        if (rng.isCollapsed() && rng.isOnAnchor()) {
                            const anchor = dom.ancestor(rng.sc, dom.isAnchor);
                            const href = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                                anchor
                            ).attr("href");
                            this.$popover
                                .find("a")
                            ...
                            const containerOffset = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                                this.options.container
                            ).offset();
                ...
                class ImageDialog_ImageDialog {
                    ...
                    initialize() {
                        ...
                        if (this.options.maximumImageFileSize) {
                            ...
                            const readableSize =
                                ...
                                " KMGTP"[unit] +
                                "B";
                            imageLimitation = `<small>${this.lang.image
                                .maximumFileSize +
                                " : " +
                                readableSize}</small>`;
                        }
                    ...
                    showImageDialog() {
                        return external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.Deferred(
                            deferred => {
                                const $imageInput = this.$dialog.find(
                                    ".note-image-input"
                                );
                                const $imageUrl = this.$dialog.find(
                                    ".note-image-url"
                                );
                                const $imageBtn = this.$dialog.find(
                                    ".note-image-btn"
                                );
                                this.ui.onDialogShown(this.$dialog, () => {
                ...
                class ImagePopover_ImagePopover {
                    ...
                    update(target, event) {
                        if (dom.isImg(target)) {
                            const position = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                                target
                            ).offset();
                            const containerOffset = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                                this.options.container
                ...
                class VideoDialog_VideoDialog {
                    ...
                    createVideoNode(url) {
                        ...
                        if (ytMatch && ytMatch[1].length === 11) {
                            ...
                            if (typeof ytMatch[2] !== "undefined") {
                                const ytMatchForStart = ytMatch[2].match(
                                    ytRegExpForStart
                                );
                    ...
                    showVideoDialog(text) {
                        return external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.Deferred(
                            deferred => {
                                const $videoUrl = this.$dialog.find(
                                    ".note-video-url"
                                );
                                const $videoBtn = this.$dialog.find(
                                    ".note-video-btn"
                                );
                                this.ui.onDialogShown(this.$dialog, () => {
                ...
                class HintPopover_HintPopover {
                    ...
                    createGroup(idx, keyword) {
                        const $group = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
            ...
            /***/ 50: /***/ function(
                ...
                class TooltipUI_TooltipUI {
                    ...
                    show() {
                        ...
                        const targetOffset = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                            this.options.target
                        ).offset();
                ...
                const dropdown = renderer["a" /* default */].create(
                    ...
                    function($node, options) {
                        const markup = Array.isArray(options.items)
                            ? options.items.map(function(item) {
                                  ...
                                  const content = options.template
                                      ...
                                      : item;
                                  const $temp = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                        ...
                        $node.on("click", "> .note-dropdown-item", function(e) {
                            const $a = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                                this
                            );
                        ...
                        children: [
                            ...
                            dropdown({
                                ...
                                click: function(event) {
                                    ...
                                    const foreinput = document.getElementById(
                                        "html5fcp"
                                    ).value;
